...
/** @param {ReturnType<typeof parseUnitTags>} unitTags @param {string} layer */
...
/** @param {ReturnType<typeof parseUnitTags>} unitTags @param {string} genKey */
export function hasExplicitGenTag(unitTags, genKey) {
  return unitTags.gen.has(genKey)
}

/** Map pattern id to gen tag key (e.g. moduleTest.stub → module-stub) */
export function patternGenKey(patternId) {
  return patternId.replaceAll('.', '-')
}
