...
**Docs:** `src/make_help.md` (bắt buộc), `docs/api-base/CONVENTIONS.md`, `docs/api-base/GENERATORS.md`

**Cursor rules:** `api-invariants.mdc`, `api-code-size.mdc`, `api-base-*.mdc` (legacy globs if any)

**Extracts:** `.cursor/extracts/` — entity, http-layer, codegen, media-s3, agent-discipline, hashtags
